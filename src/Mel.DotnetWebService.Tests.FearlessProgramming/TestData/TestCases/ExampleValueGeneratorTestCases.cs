...
public class ExampleValueGeneratorTestCases
{
	...
	public static IEnumerable<TestCasesAggregation<TestCase>> LeafObjectsAggregatedIntoSingleTestCase
	{
		get
		{
			...
			yield return ValueTypesConstrainedFurthermore;
	...
	[
		new(typeof(ClassArchetype.NonEmptyGuidStartingWithTheCharacter3),               "\"35f1a529-a087-4e07-bd93-9776f6aaf546\""),
		new(typeof(ClassArchetype.NonEmptyGuidStartingAndEndingWithTheCharacter3),      "\"35f1a529-a087-4e07-bd93-9776f6aaf543\""),
	]);
