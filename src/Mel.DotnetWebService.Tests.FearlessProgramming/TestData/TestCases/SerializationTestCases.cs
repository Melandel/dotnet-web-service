...
class SerializationTestCases
{
	...
	const string Str = "[[[[\"00000000-0000-0000-0000-000000000001\"]],[[\"00000000-0000-0000-0000-000000000001\"]]],[[[\"00000000-0000-0000-0000-000000000001\"]],[[\"00000000-0000-0000-0000-000000000001\"]]]]";
	...
	{
		if (data.GetType() == typeof(ClassArchetype.NonEmptyGuids))
		{
			var v = 0;
		}
		...
		})
		{
			...
			if (arrayOfTArrays.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (arrayOfTLists.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (arrayOfTIEnumerables.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (arrayOfTNonEmptyArrays.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }

			if (listOfTArrays.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (listOfTLists.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (listOfTIEnumerables.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (listOfTNonEmptyArrays.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }

			if (iEnumerableOfTArrays.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (iEnumerableOfTLists.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (iEnumerableOfTIEnumerables.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (iEnumerableOfTNonEmptyArrays.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }

			if (nonEmptyArrayOfTArrays.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (nonEmptyArrayOfTLists.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (nonEmptyArrayOfTIEnumerables.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
			if (nonEmptyArrayOfTNonEmptyArrays.Name == "<>z__ReadOnlySingleElementList`1[][]") {
				var w = 0; }
