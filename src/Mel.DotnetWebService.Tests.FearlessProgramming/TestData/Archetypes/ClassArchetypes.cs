...
static class ClassArchetype
{
	...
	//	public static new NonEmptyGuidStartingWithTheCharacter2 Constraining(string guidString)
	//	{
	//		try { return new(NonEmptyGuid.Constraining(guidString)); }
	...
	public sealed class NonEmptyGuidStartingWithTheCharacter3 : ConstrainedFurthermore<NonEmptyGuid>, IConstrainedValue<Guid, NonEmptyGuidStartingWithTheCharacter3>
	{
		...
		=> ExampleValues.ValidAndInvalid(
			...
			new Dictionary<Guid, string>
			{
				...
				{ Guid.Parse("03333333-3333-3333-3333-333333333333"), "Value must start with the character '3'" },
			});
	...
	public sealed class NonEmptyGuidStartingAndEndingWithTheCharacter3 : ConstrainedFurthermore<NonEmptyGuidStartingWithTheCharacter3>, IConstrainedValue<Guid, NonEmptyGuidStartingAndEndingWithTheCharacter3>
	{
		...
		=> ExampleValues.ValidAndInvalid(
			...
			new Dictionary<Guid, string>
			{
				{ Guid.Empty, "Value must start with the character '3'" },
				{ Guid.Parse("03333333-3333-3333-3333-333333333333"), "Value must start with the character '3'" },
				{ Guid.Parse("33333333-3333-3333-3333-333333333330"), "Value must end with the character '3'" },
			});
	...
	public sealed class NonEmptyGuids : ConstrainedCollection<NonEmptyGuid[]>, IConstrainedCollection<NonEmptyGuid, NonEmptyGuids>
	{
		...
		public static NonEmptyGuids FromStrings(params string[] strings)
		{
			try
			{
				return ApplyConstraintsTo(strings.Select(str => NonEmptyGuid.ApplyConstraintsTo(Guid.Parse(str))).ToArray());
			}
		...
		public static NonEmptyGuids ApplyConstraintsTo(IEnumerable<NonEmptyGuid> collection)
		{
			try
			{
	...
	//	}
	//}
	public sealed class NonEmptyGuidsWithPublicProperty : ConstrainedCollection<NonEmptyGuid[]>, IConstrainedCollection<NonEmptyGuid, NonEmptyGuidsWithPublicProperty>
	{
		...
		public static NonEmptyGuidsWithPublicProperty FromStrings(params string[] strings)
		{
			try
			{
				return ApplyConstraintsTo(strings.Select(guid => NonEmptyGuid.ApplyConstraintsTo(Guid.Parse(guid))));
			}
			catch (ObjectConstructionException objectConstructionException)
			{
		...
		public static NonEmptyGuidsWithPublicProperty ApplyConstraintsTo(IEnumerable<NonEmptyGuid> collection)
		{
			try
			{
				return new(collection.ToArray());
	...
	public sealed class EncapsulationOfAnArrayOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter : ConstrainedCollection<NonEmptyGuid[]>, IConstrainedCollection<NonEmptyGuid, EncapsulationOfAnArrayOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter>
	{
		...
		public static EncapsulationOfAnArrayOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter ApplyConstraintsTo(IEnumerable<NonEmptyGuid> collection)
		{
			try
			{
				return new(collection.ToArray());
	...
	public sealed class EncapsulationOfAHashSetOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter : ConstrainedCollection<HashSet<NonEmptyGuid>>, IConstrainedCollection<NonEmptyGuid, EncapsulationOfAHashSetOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter>
	{
		...
		public static EncapsulationOfAHashSetOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter ApplyConstraintsTo(IEnumerable<NonEmptyGuid> collection)
		{
			try
			{
				return new(new HashSet<NonEmptyGuid>(collection));
			}
			catch (ObjectConstructionException objectConstructionException)
			{
				objectConstructionException.EnrichConstructionFailureContextWith<NonEmptyGuids>(collection);
