			...
			public class When_HttpVerb_IsPost
			{
				public class When_Input_Contains_ConstrainedCollection
				{
					...
					public async Task As_RootObject()
					{
						...
						var payload = NonEmptyHashSet.CreateFromElements(Guid.Parse("f0cae17c-0219-4a8f-9966-6b34601df708"), Guid.Parse("d45ebe7d-b983-432b-87b6-b7ccf7d514e9")).GetStringRepresentation();
				...
				public class When_Input_Contains_ConstrainedType
				{
					...
					public async Task As_RootObject()
					{
						...
						var payload = NonEmptyGuid.ApplyConstraintsTo("3a6f9351-711b-4244-9124-9fec321a9c3c").GetStringRepresentation();
					...
					public async Task InsideARootArray()
					{
						...
						var payload = new[]
						{
							NonEmptyGuid.ApplyConstraintsTo("ecc1b56d-b71c-47ed-89e5-8181d741638e"),
							NonEmptyGuid.ApplyConstraintsTo("23f7a299-109b-4962-ac08-5b038186981d")
					...
					public async Task InsideARootList()
					{
						...
						{
							NonEmptyGuid.ApplyConstraintsTo("eb44460e-8ddd-436a-b845-99543ba9efad"),
							NonEmptyGuid.ApplyConstraintsTo("eede98f8-0b98-40ee-a86b-67b4a37a2359")
						}.GetStringRepresentation();
					...
					public async Task InsideARootHashSet()
					{
						...
						{
							NonEmptyGuid.ApplyConstraintsTo("11345d6b-4048-43c4-ac9e-b963c59d2159"),
							NonEmptyGuid.ApplyConstraintsTo("b04128bd-101e-46ab-a7c1-bcadac6f9aa1")
						}.GetStringRepresentation();
					...
					public async Task InsideARootEncapsulationOfAnArrayOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter()
					{
						...
						var payload = EncapsulationOfAnArrayOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter.ApplyConstraintsTo(
						new[] {
							Guid.Parse("dc3bd957-b3ac-411b-bc6d-e6606b684aea"),
							Guid.Parse("84443d55-f7a5-43bb-8ae3-7914f23bd804")
						}).GetStringRepresentation();
					...
					public async Task InsideARootEncapsulationOfAHashSetOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter()
					{
						...
						var payload = EncapsulationOfAHashSetOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableParameter.ApplyConstraintsTo(
						new[] {
							Guid.Parse("d527d99b-5343-4fed-8138-dceabb128293"),
							Guid.Parse("23333b57-1e05-419f-bf74-a9faa7a315c9")
						}).GetStringRepresentation();
					...
					public async Task InsideARootEncapsulationOfAHashSetOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableOfGuidsParameter()
					{
						...
						var payload = EncapsulationOfAHashSetOfNonEmptyGuidsExposingAFactoryMethodTakingAnIEnumerableOfGuidsParameter.ApplyConstraintsTo(
						new Guid[] {
					...
					public async Task InsideARootDictionary()
					{
						...
						{
							{ StringArchetype.Foo, NonEmptyGuid.ApplyConstraintsTo("cb023949-05d8-41f5-957a-5628fc9fa83d") },
							{ StringArchetype.Bar, NonEmptyGuid.ApplyConstraintsTo("3e00b96a-8e00-462d-a611-639634ded4c6") },
						}.GetStringRepresentation();
					...
					public async Task InsideAnRootArrayOfArrays()
					{
						...
						var payload = new[]
						{
							new[]
							{
								NonEmptyGuid.ApplyConstraintsTo("d4d10a51-8f95-455c-86b3-d34f1bcb1800"),
								NonEmptyGuid.ApplyConstraintsTo("63a83cda-b5c8-4c05-9772-90e199cdfe84")
							},
							new[]
							{
								NonEmptyGuid.ApplyConstraintsTo("90f68541-484f-4f21-9c2d-d577eead9a35"),
								NonEmptyGuid.ApplyConstraintsTo("494ec89b-1f20-49dd-9248-cb4186281715")
							}
						}.GetStringRepresentation();
					...
					public async Task As_APropertyOf_RootObject()
					{
						...
						var payload = new ClassArchetype.PositionalRecordContainingANonEmptyGuid(
							StringArchetype.Foo,
							NonEmptyGuid.ApplyConstraintsTo("1184cb10-0428-4d35-b6e0-ebe9413bfcbb")).GetStringRepresentation();
					...
					public async Task As_APropertyOf_RootObject_From_StringWithDifferentPropertyOrder()
					{
						...
						var payloadAsObject = new ClassArchetype.PositionalRecordContainingANonEmptyGuid(
							StringArchetype.Foo,
							NonEmptyGuid.ApplyConstraintsTo("ffabd9c8-dc4f-482f-9954-d6cd06816cc3"));
					...
					public async Task As_APropertyOf_RootObject_SettersOnly()
					{
						...
						var payload = new ClassArchetype.GetSetStyleClassContainingANonEmptyGuid
						{
							...
							SecondProperty = NonEmptyGuid.ApplyConstraintsTo("6fb00d4b-4688-437b-a45e-0febeedceed6")
						}.GetStringRepresentation();
					...
					public async Task As_APropertyOf_Objects_InsideRootArray()
					{
						...
						var payload = new[]
						{
							new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Foo, NonEmptyGuid.ApplyConstraintsTo("e1d9d98e-6752-43dd-af10-d66dbf9b5037")),
							new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Bar, NonEmptyGuid.ApplyConstraintsTo("a3ea4100-32b5-41e3-9a76-f67e8b350e02"))
						}.GetStringRepresentation();
					...
					public async Task As_APropertyOf_Objects_InsideRootList()
					{
						...
						{
							new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Foo, NonEmptyGuid.ApplyConstraintsTo("924c9966-2d88-4840-959d-ddb2ecf8af59")),
							new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Bar, NonEmptyGuid.ApplyConstraintsTo("aa708279-389a-46de-92fe-14d3522bcbe0"))
						}.GetStringRepresentation();
					...
					public async Task As_APropertyOf_Objects_InsideRootIEnumerable()
					{
						...
						{
							new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Foo, NonEmptyGuid.ApplyConstraintsTo("ca727cfa-43c0-40de-961f-de244b82c5d0")),
							new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Bar, NonEmptyGuid.ApplyConstraintsTo("7851c746-f86e-4cc1-a290-6b2eabea35c8"))
						}.GetStringRepresentation();
					...
					public async Task As_AnArrayPropertyOf_RootObject()
					{
						...
						var payload = new ClassArchetype.PositionalRecordContainingAnArrayOfNonEmptyGuids(
							...
							new[]
							{
								NonEmptyGuid.ApplyConstraintsTo("49c27a56-8e4a-46fc-b60a-d74b4bc6692e"),
								NonEmptyGuid.ApplyConstraintsTo("d8ad6467-eb49-4d3c-bfac-3a6f4aeb11b4"),
							}
						).GetStringRepresentation();
					...
					public async Task As_AnArrayPropertyOf_RootObject_NextToAnArrayOfInts()
					{
						...
						var payload = new ClassArchetype.PositionalRecordContainingAnArrayOfNonEmptyGuidsAndAnArrayOfInts(
							...
							new[]
							{
								NonEmptyGuid.ApplyConstraintsTo("d3b75988-820c-4726-8db1-028305432428"),
								NonEmptyGuid.ApplyConstraintsTo("78fde2ba-cb10-4706-8053-cd1a78cb310a"),
							},
					...
					public async Task As_AnIEnumerablePropertyOf_RootObject()
					{
						...
						var payload = new ClassArchetype.PositionalRecordContainingAnIEnumerableOfNonEmptyGuids(
							...
							{
								NonEmptyGuid.ApplyConstraintsTo("767ee8ed-069c-4f1f-a4f6-23f13940f0ca"),
								NonEmptyGuid.ApplyConstraintsTo("05f97c30-a54f-4e33-963a-27dce2902960"),
							}).GetStringRepresentation();
					...
					public async Task As_APropertyOf_ObjectContainedByRootObject()
					{
						...
						var payload = new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingANonEmptyGuid(
							...
							new ClassArchetype.PositionalRecordContainingANonEmptyGuid(
								StringArchetype.Foo,
								NonEmptyGuid.ApplyConstraintsTo("b5fcd95a-7ace-417f-8214-2590fdbd315e")))
							.GetStringRepresentation();
					...
					public async Task As_APropertyOf_ObjectContainedByObjects_InsideRootArray()
					{
						...
						var payload = new[]
						{
							new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingANonEmptyGuid(
								StringArchetype.Foo,
								new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Bar, NonEmptyGuid.ApplyConstraintsTo("a943ebd2-8521-4b2e-92c5-f09314aba4f7"))),
							new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingANonEmptyGuid(
								StringArchetype.Baz,
								new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Foobar, NonEmptyGuid.ApplyConstraintsTo("caef8451-2e13-4e13-bf4c-2861bdd28998")))
						}.GetStringRepresentation();
					...
					public async Task As_APropertyOf_ObjectContainedByObjects_InsideRootList()
					{
						...
						var payload = new List<ClassArchetype.PositionalRecordContainingAPositionalRecordContainingANonEmptyGuid>
						{
							new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingANonEmptyGuid(
								StringArchetype.Foo,
								new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Bar, NonEmptyGuid.ApplyConstraintsTo("ce129a85-0d9e-4c3a-99ec-dae914a2bbdc"))),
							new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingANonEmptyGuid(
								StringArchetype.Baz,
								new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Foobar, NonEmptyGuid.ApplyConstraintsTo("06dca32f-1166-4390-9b59-bfdca58304c2")))
						}.GetStringRepresentation();
					...
					public async Task As_APropertyOf_ObjectContainedByObjects_InsideRootIEnumerable()
					{
						...
						var payload = new HashSet<ClassArchetype.PositionalRecordContainingAPositionalRecordContainingANonEmptyGuid>
						{
							new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingANonEmptyGuid(
								StringArchetype.Foo,
								new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Bar, NonEmptyGuid.ApplyConstraintsTo("3cfda204-70bd-43c9-ab8b-6f44d6941d6a"))),
							new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingANonEmptyGuid(
								StringArchetype.Baz,
								new ClassArchetype.PositionalRecordContainingANonEmptyGuid(StringArchetype.Foobar, NonEmptyGuid.ApplyConstraintsTo("4ee015f3-43f1-400f-a685-e26326ba1646")))
						}.GetStringRepresentation();
					...
					public async Task As_AnArrayPropertyOf_ObjectContainedByRootObject()
					{
						...
						var payload = new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingAnArrayOfNonEmptyGuids(
							...
							new ClassArchetype.PositionalRecordContainingAnArrayOfNonEmptyGuids(
								...
								new[]
								{
									NonEmptyGuid.ApplyConstraintsTo("6c2aa526-bd51-4436-8a5f-91814501b824"),
									NonEmptyGuid.ApplyConstraintsTo("18c309d3-5f3c-4f57-befb-904b51ead9e8")
								})).GetStringRepresentation();
					...
					public async Task As_AListPropertyOf_ObjectContainedByRootObject()
					{
						...
						var payload = new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingAListOfNonEmptyGuids(
							...
							new ClassArchetype.PositionalRecordContainingAListOfNonEmptyGuids(
								...
								new List<NonEmptyGuid>
								{
									NonEmptyGuid.ApplyConstraintsTo("cb894f78-bffd-4c97-9e98-a17d96f0bed7"),
									NonEmptyGuid.ApplyConstraintsTo("27d88795-db6c-4d35-ac7d-9e2977a15102")
								})).GetStringRepresentation();
					...
					public async Task As_AnIEnumerablePropertyOf_ObjectContainedByRootObject()
					{
						...
						var payload = new ClassArchetype.PositionalRecordContainingAPositionalRecordContainingAListOfNonEmptyGuids(
							...
							new ClassArchetype.PositionalRecordContainingAListOfNonEmptyGuids(
								...
								new List<NonEmptyGuid>
								{
									NonEmptyGuid.ApplyConstraintsTo("402f1135-521d-4017-bd7b-23559fa38375"),
									NonEmptyGuid.ApplyConstraintsTo("0b876528-8064-4cce-bbd9-ef66ebd6c29a")
								})).GetStringRepresentation();
