...
class ObjectRenderingShould
{
	...
	public class RenderTheEncapsulatedTypeOnTypesThatInheritTheConstrainedClass
	{
		public class WhenRenderingAnObject
		{
			...
			[Test]
			public void That_InvolvesFieldsOrProperties_That_AreCollectionOfObjects_That_InvolvesFieldsOrProperties_That_AreDictionaryOfObjects_That_DirectlyInheritTheConstrainedClass()
			{
			}

			[Test]
			public void That_InvolvesFieldsOrProperties_That_AreCollectionOfObjects_That_InvolvesFieldsOrProperties_That_AreDictionaryOfObjects_That_Inherit_AnObjectThatInherits_TheConstrainedClass()
			{
			}

			[Test]
			public void That_InvolvesFieldsOrProperties_That_AreCollectionOfObjects_That_InvolvesFieldsOrProperties_That_AreDictionaryOfObjects_That_Inherit_AConstrainedClass_WhoseGenericTypeIs_AnObjectThatInherits_TheConstrainedClass()
			{
			}
