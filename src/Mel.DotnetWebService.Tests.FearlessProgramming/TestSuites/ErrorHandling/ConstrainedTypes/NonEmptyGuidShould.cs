		...
		Throws.Exception
			...
			.With.Message.EqualTo(
				string.Join(Environment.NewLine,
					"NonEmptyGuid: construction failed via NonEmptyGuid.FromGuid(Guid) with the following parameter: \"00000000-0000-0000-0000-000000000000\" [Mel.DotnetWebService.CrossCuttingConcerns.ConstrainedTypes.Guids]",
					"NonEmptyGuid: Value cannot accept value \"00000000-0000-0000-0000-000000000000\": Value must not be empty [Mel.DotnetWebService.CrossCuttingConcerns.ConstrainedTypes.Guids]")));
}
