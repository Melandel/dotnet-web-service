using Mel.DotnetWebService.CrossCuttingConcerns.ConstrainedPrimitiveTypes;
...
#pragma warning restore NUnit2021 // Incompatible types for EqualTo constraint
	...
	=> Assert.That(
		...
		Throws.Exception
			...
			.With.Message.EqualTo("NonEmptyGuid: _encapsulated cannot accept value 00000000-0000-0000-0000-000000000000 [Mel.DotnetWebService.CrossCuttingConcerns.ConstrainedPrimitiveTypes]"));
}
