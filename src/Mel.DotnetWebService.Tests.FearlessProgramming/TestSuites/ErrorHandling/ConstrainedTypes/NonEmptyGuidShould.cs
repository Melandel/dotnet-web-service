		...
		Throws.Exception
			...
			.With.Message.EqualTo(
				string.Join(Environment.NewLine,
					...
					"NonEmptyGuid: Encapsulated cannot accept value \"00000000-0000-0000-0000-000000000000\": Encapsulated must not be empty [Mel.DotnetWebService.CrossCuttingConcerns.ConstrainedTypes]")));
}
