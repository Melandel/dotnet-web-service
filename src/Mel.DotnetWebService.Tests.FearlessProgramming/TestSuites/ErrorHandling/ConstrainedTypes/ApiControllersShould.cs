		...
		public class Inside_Body
		{
			public class When_HttpVerb_IsPost
			{
				public class When_Input_Contains_ConstrainedType
				{
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/hashset-of-non-empty-guids-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/encapsulation-of-an-array-of-non-empty-guids-exposing-a-factory-method-taking-an-ienumerable-parameter-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/encapsulation-of-an-array-of-non-empty-guids-exposing-a-factory-method-taking-an-array-parameter-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/encapsulation-of-an-ienumerable-of-non-empty-guids-exposing-a-factory-method-taking-an-array-parameter-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/encapsulation-of-a-hashset-of-non-empty-guids-exposing-a-factory-method-taking-an-array-parameter-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/encapsulation-of-a-hashset-of-non-empty-guids-exposing-a-factory-method-taking-an-ienumerable-parameter-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/encapsulation-of-a-hashset-of-non-empty-guids-exposing-a-factory-method-taking-an-ienumerable-of-guids-parameter-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/encapsulation-of-an-array-of-non-empty-guids-exposing-a-constructor-taking-an-array-parameter-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/encapsulation-of-an-array-of-non-empty-guids-exposing-a-constructor-taking-an-ienumerable-parameter-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/dictionary-with-string-keys-and-non-empty-guid-values-inside-body/";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/array-of-arrays-of-non-empty-guids-inside-body/";
						var payload = new[]
						{
							new[]
							{
					...
					{
						// Arrange
						var requestUri = "/api/v1/stubbed-endpoints-specifically-created-for-tests/get-set-style-class-containing-non-empty-guid-inside-body";
					...
					{
						// Arrange
						var requestUri = "api/v1/stubbed-endpoints-specifically-created-for-tests/positional-record-containing-an-array-of-non-empty-guids-and-an-array-of-ints-inside-body/";
