...
public static class ArrayWithAtLeast2Items
{
	...
	public static ArrayWithAtLeast2Items<T> CreateFromTwoElements<T>(T firstElement, T secondElement) => ArrayWithAtLeast2Items<T>.ApplyConstraintsTo([firstElement, secondElement]);
