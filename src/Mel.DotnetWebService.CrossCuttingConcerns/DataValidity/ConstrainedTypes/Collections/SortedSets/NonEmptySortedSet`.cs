...
public sealed class NonEmptySortedSet<T> : ConstrainedSortedSet<T>, IConstrainedCollection<T, NonEmptySortedSet<T>>
{
	NonEmptySortedSet(SortedSet<T> sortedSet) : base(sortedSet)
	{
