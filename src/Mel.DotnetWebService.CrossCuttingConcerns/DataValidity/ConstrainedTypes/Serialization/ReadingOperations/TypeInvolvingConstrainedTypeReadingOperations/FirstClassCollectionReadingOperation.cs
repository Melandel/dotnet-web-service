...
class FirstClassCollectionReadingOperation : TypeInvolvingConstrainedTypeReadingOperation
{
	static readonly FirstClassCollectionReadingOperation _instance = new();
	static readonly Dictionary<Type, Type> InstanciationOperationParameterTypesByTypeToConstruct = new Dictionary<Type, Type>();
	FirstClassCollectionReadingOperation()
	{
	}

	public static FirstClassCollectionReadingOperation Instance(Type targetType, Type? constructorParameterType, Type[] instanciationOperationParameterTypeCandidates)
	{
