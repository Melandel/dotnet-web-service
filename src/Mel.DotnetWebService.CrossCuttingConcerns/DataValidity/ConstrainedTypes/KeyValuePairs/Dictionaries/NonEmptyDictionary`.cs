...
public sealed class NonEmptyDictionary<TKey, TValue> : ConstrainedDictionary<TKey, TValue>, IConstrainedCollectionOfKeyValuePairs<TKey, TValue, NonEmptyDictionary<TKey, TValue>> where TKey : notnull
{
	NonEmptyDictionary(Dictionary<TKey, TValue> dictionary) : base(dictionary)
	{
	...
	public static NonEmptyDictionary<TKey, TValue> ApplyConstraintsTo(IEnumerable<KeyValuePair<TKey, TValue>> collectionOfKeyValuePairs)
	{
		try { return new(collectionOfKeyValuePairs.ToDictionary()); }
		catch (ObjectConstructionException objectConstructionException) { objectConstructionException.EnrichConstructionFailureContextWith<NonEmptyDictionary<TKey, TValue>>(collectionOfKeyValuePairs); throw; }
		catch (Exception defect) { throw ObjectConstructionException.WhenConstructingAnInstanceOf<NonEmptyDictionary<TKey, TValue>>(defect, collectionOfKeyValuePairs); }
	}
}
