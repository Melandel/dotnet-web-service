...
public abstract class ConstrainedSortedList<TKey, TValue>
	: ConstrainedCollectionOfKeyValuePairs<SortedList<TKey, TValue>>,
		IDictionary<TKey, TValue>,
		IDictionary,
		IReadOnlyDictionary<TKey, TValue> where TKey : notnull
{
	protected ConstrainedSortedList(SortedList<TKey, TValue> sortedList) : base(sortedList)
	{
	}
