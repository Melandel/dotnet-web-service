...
public sealed class NonZeroShort : ConstrainedShort, IConstrainedShort<NonZeroShort>
{
	...
	=> ExampleValues.ValidAndInvalid(
		validValues: ExampleValues.ForShortType.Where(s => s != default),
		constraintViolationExamples: [ ConstraintViolationExample.Document<short>(0, "Value must not be zero") ]);
