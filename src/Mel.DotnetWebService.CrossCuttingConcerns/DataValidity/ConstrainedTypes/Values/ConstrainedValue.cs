		...
		IEquatable<TValue?>
{
	...
	{
		TValue v => Equals(v),
		ConstrainedValue<TValue> v => Equals(v),
		var v => Value.Equals(v)
	};
	public bool Equals(TValue? other) => Value.Equals(other);
	public bool Equals(ConstrainedValue<TValue>? other) => other is not null && Value.Equals(other.Value);

	public int CompareTo(object? obj) => obj switch
	{
		TValue v => CompareTo(v),
		ConstrainedValue<TValue> v => CompareTo(v),
		var v => Value.CompareTo(v)
	};
	...
	=> (a, b) switch
	{
		...
		(not null, null) => false,
		(null, null) => true,
		({ Value: var va }, { Value: var vb }) => va.Equals(vb)
	};
