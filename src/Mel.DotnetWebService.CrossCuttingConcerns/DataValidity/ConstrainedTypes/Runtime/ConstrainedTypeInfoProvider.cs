...
class ConstrainedTypeInfoProvider : IConstrainedTypeInfoProvider
{
	...
	public bool TryGet(Type type, out ConstrainedTypeInfo constrainedTypeInfo)
	{
		...
		var isFullyResolvedFromConstrainedGenericType = type.IsGenericType && !type.ContainsGenericParameters && _unresolvedGenericConstrainedTypes.Contains(type.GetGenericTypeDefinition());
