...
public static class ConstrainedTypeInfos
{
	...
	public static bool IsLoaded(out string loadedAssemblyName)
	{
		if (ConstrainedTypeInfoProvider.Instance == null)
		{
			loadedAssemblyName = "";
			return false;
		}

		return ConstrainedTypeInfoProvider.Instance.IsLoaded(out loadedAssemblyName);
	}
