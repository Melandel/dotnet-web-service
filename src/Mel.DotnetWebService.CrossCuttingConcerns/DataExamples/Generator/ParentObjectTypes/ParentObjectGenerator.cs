			...
			generator = type switch
				{
					...
					var t when t.IsAFirstClassCollectionWithIConstrainedCollection(out var instanciationOperationParameterType)      => FirstClassCollectionParentObjectGenerator.Instance(type, instanciationOperationParameterType),
