...
public static class TypeExtensionMethods
{
	...
	public static bool HasFieldOrPropertieWithConstrainedType(this Type type, bool browseRecursively = false)
	{
		...
		if (fieldTypes.Any(fieldType => fieldType.IsAConstrainedType() || fieldType.IsAGenericCollectionType(argType => argType.IsOrInvolvesAConstrainedType())))
		{
			return true;
		}
		...
		if (propertyTypes.Any(propertyType => propertyType.IsAConstrainedType() || propertyType.IsAGenericCollectionType(argType => argType.IsOrInvolvesAConstrainedType())))
		{
			return true;
		}
