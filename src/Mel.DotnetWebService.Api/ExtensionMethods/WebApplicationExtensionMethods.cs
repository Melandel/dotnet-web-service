...
public static class WebApplicationExtensionMethods
{
	...
	public static WebApplication UseCustomExceptionHandlingCompliantWithRfc7807(this WebApplication app)
	{
		app.UseMiddleware<ReturnProblemDetailsWhenExceptionIsThrown>();
		return app;
	}
}
